    ...
    render() {
        ...
        return (
            <div>
                ...
                <form method="POST"  encType="multipart/form-data" onSubmit={this.createFunction}>
                    ...
                    <div className="editor">
                        <div className="toolbar">
                            <div className="line">
                                ...
                                <div className="box">
                                    ...
                                    <span className="btn icon" data-action="insertUnorderedList" title="Insert unordered list">
                                        <img src={Insertunorderedlist} alt="Insert unordered list" />
                                    </span>
                                    <span className="btn icon" data-action="outdent" title="Outdent">
                                        <img src={Outdent} alt="Outdent" />
                                    </span>
                                    <span className="btn icon" data-action="indent" title="Indent">
                            ...
                            <div className="line">
                                ...
                                <div className="box">
                                    <span className="btn icon smaller" data-action="createLink" title="Insert Link">
                                ...
                                <div className="box">
                                    <span className="btn icon" data-action="insertImage" title="Show ">
                                        <img src={Showhtml} alt="show html" />
                                    </span>
                                </div>
                        ...
                        <div className="content-area">
                            <div className="visuell-view" contentEditable='true' suppressContentEditableWarning='true' >
                                write here..
